...
### Proxy Design
- The Next.js API route acts as a proxy to the evaluation service.
- **Security**: Masks the `clientID` and `clientSecret` from the client-side.
- **Validation**: Enforces the 5-10 limit constraint before calling the upstream service.
